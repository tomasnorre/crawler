...
class CrawlerApiTest extends \TYPO3\CMS\Core\Tests\FunctionalTestCase
{
    ...
    public function canCreateQueueEntrysUsingConfigurationRecord()
    {
        ...
        $this->assertEquals($queueItems[0]['parameters'], $assertedParameter,
        ...
        $this->assertEquals($queueItems[1]['parameters'], $assertedParameter,
            'Wrong queue parameters created by crawler lib for configuration record');
    ...
    protected function getMockedCrawlerAPI($currentTime)
    {
        ...
        //create mocked api
        $crawler_api = $this->getMock(CrawlerApi::class, array('findCrawler'));
