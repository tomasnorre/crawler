...
where page rankings are listed as well. Their rankings will most likely be higher the
...
processing the crawler queue. This means that if you have a page with high ranking
...
you and your end-user based on your sitemap priority ranking. We choose to
...
options that the `sysext/seo` gives you and all pages will by default get a ranking
