...
CREATE TABLE tx_crawler_queue (
  ...
  result_data longtext DEFAULT ''  NOT NULL,
...
CREATE TABLE tx_crawler_configuration (
  ...
  processing_instruction_parameters_ts text DEFAULT '' NOT NULL,
  configuration text DEFAULT ''  NOT NULL,
  base_url tinytext DEFAULT ''  NOT NULL,
  sys_domain_base_url tinytext DEFAULT ''  NOT NULL,
  pidsonly blob,
